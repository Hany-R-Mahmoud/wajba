  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-stone-950/70 backdrop-blur-sm overflow-y-auto animate-in fade-in duration-200">
      <div className="relative w-full max-w-3xl bg-white dark:bg-stone-900 rounded-3xl shadow-2xl border border-amber-200/80 dark:border-stone-800 my-8 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="relative h-64 sm:h-72 w-full bg-amber-950 flex-shrink-0">
          <img
            src={recipe.image}
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 p-2.5 rounded-full bg-stone-900/60 hover:bg-stone-900/90 backdrop-blur-md text-white transition-all shadow-md z-10"
          >
            <X className="w-5 h-5" />
          </button>
          ...
          <div className="absolute bottom-4 right-4 left-4 text-white">
            <span className={`inline-block mb-2 px-3 py-1 rounded-full text-xs font-bold border backdrop-blur-md ${regionInfo.bg}`}>
